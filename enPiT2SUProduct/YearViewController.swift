...
class YearViewController: UIViewController {
        ...
        for month in 1...12 {
            ...
            case 1,3,5,7,8,10,12:
                ...
                for count in 01 ... 31 {
                    ...
                    sum += recordMgr.loadCalorie(date: days)
                }
    ...
    func setChart(dataPoints: [String], values: [Double]){
        ...
        // 横に赤いボーダーラインを描く
        let cGoal: Double = appDelegate.goalCalo * 31
...
public class BarChartFormatterYear: NSObject, IAxisValueFormatter{
    ...
    // x軸のラベル
    var years: [String]! = ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"]
